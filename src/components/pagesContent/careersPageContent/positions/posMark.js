...
function Posmark() {
  ...
  return (
    <div className="manager_pos">
      <div className="position">
        <h4 className="position_title">Marketing Manager</h4>
        <p className="position_p">
          Involved in developing effective marketing strategies and executing
          marketing campaigns.
        </p>
